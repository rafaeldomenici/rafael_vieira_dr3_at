...
const queryItemImage = `
    ...
    const queryItemEtapa = `
        PRAGMA journal_mode = WAL;
        CREATE TABLE IF NOT EXISTS item_etapa (
            uid TEXT PRIMARY KEY NOT NULL, 
            etapa TEXT NOT NULL, 
            itemUid TEXT NOT NULL,
            createdAt TEXT, 
...
const createTables = async() => {
    try{
        ...
        await db.execAsync(queryItemIngrediente);
        await db.execAsync(queryItemEtapa);
